    ...
    private void configureReceiverMessageHolder(ReceiverMessageHolder receiverMessageHolder, int position){
        ...
        if(receiver != null){
            if(receiver.getPhotoUrl() == null){
                ...
                Glide.with(context).load(receiver.getPhotoUrl()).into(receiverMessageHolder.circleImageView);
            }
    ...
    private void configureReceiverStickerHolder(ReceiverStickerHolder receiverStickerHolder, int position){
        if(receiver != null){
            if(receiver.getPhotoUrl() == null){
                ...
                Glide.with(context)
                        .load(receiver.getPhotoUrl())
                        .into(receiverStickerHolder.circleImageView);
            }
