...
public class ProfileUpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Drawable upArrow = ContextCompat.getDrawable(ProfileUpdateActivity.this,R.drawable.abc_ic_ab_back_material);
        upArrow.setColorFilter(ContextCompat.getColor(ProfileUpdateActivity.this,R.color.icons), PorterDuff.Mode.SRC_ATOP);
