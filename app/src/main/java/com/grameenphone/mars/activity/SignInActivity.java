        ...
        switch (uiState) {
            ...
            case STATE_CODE_SENT:
                ...
                if (!TextUtils.isEmpty(phoneNumber)) {
                    logo.setImageDrawable(getResources().getDrawable(R.drawable.pin_sent));
            ...
            case STATE_VERIFY_SUCCESS:
                ...
                if (cred != null) {
                    if (cred.getSmsCode() != null) {
                        ...
                        mDetailText.setText("মার্স আপনার অ্যাক্টিভেশন অটোমেটিক্যালি করে নেবে, একটু অপেক্ষা করুন ");
                    }
                }
