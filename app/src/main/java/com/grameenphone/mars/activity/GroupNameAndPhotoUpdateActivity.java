...
public class GroupNameAndPhotoUpdateActivity extends AppCompatActivity {
   ...
   String photoUrl,Name,roomID;
    TextView NameTitle,BarTitle;
    private ImageButton Back,Save;
    public static final String GROUP_CHILD = "group_details";
       ...
       // Back.setVisibility(View.GONE);
        ...
        if(intent.hasExtra("name"))
        {
         //   Back.setVisibility(View.VISIBLE);
            ...
            NameTitle.setText("গ্রুপের নাম পরিবর্তন করুন");
            BarTitle.setText("এডিট গ্রুপ");
            name.setText(Name);
            Glide.with(GroupNameAndPhotoUpdateActivity.this)
                    .load(photoUrl)
                    .into(profilePic);
        }
...
public void saveInfo()
    {
        ...
        if((!user_name.isEmpty() && photoUrl!=null)||(!user_name.isEmpty() && profilepicUrl!=null)){
            ...
            updatedData.put("name",user_name);
            if(profilepicUrl!=null) {
                updatedData.put("groupPic", profilepicUrl);
            }
            ...
            try {
                ...
                mFirebaseDatabaseReference.child(GROUP_CHILD).child(roomID)
                        .updateChildren(updatedData);


                DatabaseHelper dbHelper = new DatabaseHelper(getApplicationContext());
                if(profilepicUrl!=null) {
                    dbHelper.addRoom(roomID, Name, profilepicUrl, "group");
                } else {
                    dbHelper.addRoom(roomID, Name, photoUrl, "group");
                }
        ...
        {
            AlertDialog.Builder alert = new AlertDialog.Builder(GroupNameAndPhotoUpdateActivity.this);
            alert.setTitle("");
