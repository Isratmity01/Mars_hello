...
public class Emojicon implements Serializable {
    ...
    public static int toCodePoint(String emoji)
    {
        int id=Integer.valueOf(emoji);
        return id;
    }
    ...
    public static Emojicon fromInt (int id)
    {
        Emojicon emoji = new Emojicon();
        emoji.drawableId = id;
        return emoji;
    ...
    public static Emojicon fromApp(String chars) {
        Emojicon emoji = new Emojicon();
        emoji.drawableIdtext = chars;
        return emoji;
    }
